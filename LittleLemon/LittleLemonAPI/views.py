...
from .serializers import Cartserializer, Categoryserializer, Menuitemserializers, Orderserializer, Userserializer
...
class Retrievemenuitem(generics.RetrieveUpdateDestroyAPIView):
    queryset = MenuItem.objects.all()
    serializer_class = Cartserializer
...
class Retrieveorder(generics.RetrieveUpdateAPIView):
    queryset = Order.objects.all()
    serializer_class = Orderserializer
    permission_classes = [IsAuthenticated]
